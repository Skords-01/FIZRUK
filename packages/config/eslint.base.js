...
import sergeantDesign from "eslint-plugin-sergeant-design";
...
/**
 * Shared ESLint flat-config building blocks for the Sergeant monorepo.
 *
 * Apps compose these with their own `files`/`ignores`/overrides so that
 * per-app concerns (e.g. DS primitives override in apps/web) stay local
 * to the workspace that owns them.
 */
...
export const prettierCompat = eslintConfigPrettier;
