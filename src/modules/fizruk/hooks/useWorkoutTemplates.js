...
export function useWorkoutTemplates() {
  ...
  const addTemplate = useCallback((name, exerciseIds) => {
    ...
    const t = { id: uid(), name: n, exerciseIds: ids, updatedAt: new Date().toISOString() };
    persist([t, ...templates]);
    return t;
  }, [persist, templates]);
  ...
  const sorted = useMemo(() => [...templates].sort((a, b) => (b.updatedAt || "").localeCompare(a.updatedAt || "")), [templates]);
