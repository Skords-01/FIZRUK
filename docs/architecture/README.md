...
| Документ                                                       | Опис                                              |
| -------------------------------------------------------------- | ------------------------------------------------- |
| [`api-v1.md`](./api-v1.md)                                     | REST API v1 контракт                              |
| [`apps-status-matrix.md`](./apps-status-matrix.md)             | Статус-матриця всіх apps і packages               |
| [`apps-web-exhaustive-deps.md`](./apps-web-exhaustive-deps.md) | Exhaustive-deps правило для web useEffect/useMemo |
...
| [`platforms.md`](./platforms.md)                               | Платформи: web, mobile (Expo), mobile-shell (Cap) |
