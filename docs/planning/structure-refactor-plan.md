...
> Дата створення: 2026-04-25. Останнє оновлення статусу: 2026-04-27.
>
> Поточний стан: проект організовано на ~8/10. Монорепо, domain-пакети,
> модульна архітектура — все на високому рівні.
>
> **Status (2026-04-27):** Пріоритет 1 (1.1–1.4), Пріоритет 2 (2.1)
> та Пріоритет 3 (3.1–3.2) — **повністю виконані** (згорнуті у Done-блок
> нижче). З Пріоритету 4 виконано 4.2, 4.3, 4.4 (також згорнуті);
> залишається 4.1 (workspace-deps уніфікація) та Пріоритет 5
> (довгостроковий список великих файлів і barrel exports).
>
> **Залишок (active):** §4.1, §5.1, §5.2, §5.3 — див. нижче.

---

<details>
<summary><strong>Пріоритет 1 — Чистка ✅ done (розгорнути історичний запис)</strong></summary>
...
<details>
<summary><strong>Пріоритет 2 — Реорганізація `core/` (web) ✅ done (розгорнути)</strong></summary>
...
<details>
<summary><strong>Пріоритет 3 — Серверні покращення ✅ done (розгорнути)</strong></summary>
...
<details>
<summary><strong>4.2 / 4.3 / 4.4 — виконані пункти (розгорнути)</strong></summary>
