# ADR-0006: User deletion and PII handling
...
- **Related:**
  ...
  - [`docs/adr/0007-better-auth-choice-and-session-model.md`](./0007-better-auth-choice-and-session-model.md) — auth-stack rationale.
