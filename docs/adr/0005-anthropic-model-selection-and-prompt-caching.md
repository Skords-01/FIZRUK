...
- **Related:**
  ...
  - [`apps/server/src/modules/chat.ts`](../../apps/server/src/modules/chat.ts) — `model: "claude-sonnet-4-6"`, `applyToolsCacheBreakpoint`, `buildSystem`.
...
([`chat.ts:381-383`](../../apps/server/src/modules/chat.ts#L381-L383)).
...
```ts
// apps/server/src/modules/chat.ts:62-83
...
```ts
// apps/server/src/modules/chat.ts:52-60
