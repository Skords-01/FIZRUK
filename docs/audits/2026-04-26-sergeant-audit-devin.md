...
> **Статус виконання — оновлено 2026-04-27 (сьома ревізія: +PR-1.A, +PR-6.D, +PR-7.D, +PR-8.B, +PR-10.A, +PR-10.B link, +PR-11.A, +PR-11.B, +PR-11.C substantially complete; +PR-7.C, +PR-8.A open, +PR-4.D branch, +PR-3.A/8.C formal closure open)**
...
| Аудит-ID | Тема                                                                           | Статус           | PR (merged / open)                                                                                                                                                                                                                                                                                                                                                                                     |
| -------- | ------------------------------------------------------------------------------ | ---------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
...
| PR-7.C   | hub-reports aggregation snapshot tests                                         | ✅ closed        | [#913](https://github.com/Skords-01/Sergeant/pull/913)                                                                                                                                                                                                                                                                                                                                                 |
| PR-5.B   | rollback sanity для `*.down.sql` міграцій (Testcontainers)                     | ✅ closed        | [#918](https://github.com/Skords-01/Sergeant/pull/918)                                                                                                                                                                                                                                                                                                                                                 |
| PR-1.B   | per-app status matrix (`docs/architecture/apps-status-matrix.md`)              | ✅ closed        | [#932](https://github.com/Skords-01/Sergeant/pull/932)                                                                                                                                                                                                                                                                                                                                                 |
| PR-6.D   | `apps/server` explicit `strict: true` (no implicit inheritance)                | ✅ closed        | [#937](https://github.com/Skords-01/Sergeant/pull/937)                                                                                                                                                                                                                                                                                                                                                 |
| PR-10.B  | split smoke-e2e → critical-flow (PR) + extended-flow (nightly)                 | ✅ closed        | [#940](https://github.com/Skords-01/Sergeant/pull/940)                                                                                                                                                                                                                                                                                                                                                 |
| PR-1.A   | enforce inheritance of `strict` from `tsconfig.base` (codeowner-blocking)      | ✅ closed        | [#943](https://github.com/Skords-01/Sergeant/pull/943)                                                                                                                                                                                                                                                                                                                                                 |
| PR-10.C  | nightly full audit + osv-scanner dependency check                              | ✅ closed        | [#944](https://github.com/Skords-01/Sergeant/pull/944)                                                                                                                                                                                                                                                                                                                                                 |
| PR-7.D   | weekly flaky-tests dashboard workflow + aggregator                             | ✅ closed        | [#945](https://github.com/Skords-01/Sergeant/pull/945)                                                                                                                                                                                                                                                                                                                                                 |
| PR-8.B   | Prometheus `/metrics` + Grafana dashboards + on-call/logging/frontend obs docs | ✅ closed        | [#946](https://github.com/Skords-01/Sergeant/pull/946), [#947](https://github.com/Skords-01/Sergeant/pull/947), [#948](https://github.com/Skords-01/Sergeant/pull/948), [#949](https://github.com/Skords-01/Sergeant/pull/949), [#950](https://github.com/Skords-01/Sergeant/pull/950), [#953](https://github.com/Skords-01/Sergeant/pull/953), [#959](https://github.com/Skords-01/Sergeant/pull/959) |
| PR-10.A  | CI p95 pipeline-duration metric in PR comments                                 | ✅ closed        | [#951](https://github.com/Skords-01/Sergeant/pull/951)                                                                                                                                                                                                                                                                                                                                                 |
| PR-11.A  | freshness badges for top-10 docs + nightly overdue-doc issue workflow          | ✅ closed        | [#952](https://github.com/Skords-01/Sergeant/pull/952)                                                                                                                                                                                                                                                                                                                                                 |
| PR-11.B  | decision-tree format for top-5 playbooks                                       | ✅ closed        | [#955](https://github.com/Skords-01/Sergeant/pull/955)                                                                                                                                                                                                                                                                                                                                                 |
| PR-11.C  | ADR template + README index + retroactive ADRs (0003-0015)                     | ✅ substantially | template+README [#938](https://github.com/Skords-01/Sergeant/pull/938), ADRs [#956](https://github.com/Skords-01/Sergeant/pull/956), [#958](https://github.com/Skords-01/Sergeant/pull/958), [#961](https://github.com/Skords-01/Sergeant/pull/961), [#962](https://github.com/Skords-01/Sergeant/pull/962)                                                                                            |
| PR-6.B   | `noImplicitAny` phase 2 — routine + shared + nutrition (3 з 6)                 | 🟡 partial       | [#923](https://github.com/Skords-01/Sergeant/pull/923), [#934](https://github.com/Skords-01/Sergeant/pull/934) — ⏳ `core` / `modules/finyk` / `modules/fizruk`                                                                                                                                                                                                                                        |
| PR-7.E   | de-flake 3 known flaky mobile tests (1/3 done)                                 | 🟡 partial       | 1/3 [#963](https://github.com/Skords-01/Sergeant/pull/963) — ⏳ 2/3 + 3/3                                                                                                                                                                                                                                                                                                                              |
| PR-3.A   | formally subsumed by PR-6.A/6.B/6.C (doc-only closure)                         | 🟠 open (doc)    | [#941](https://github.com/Skords-01/Sergeant/pull/941) OPEN                                                                                                                                                                                                                                                                                                                                            |
| PR-8.A   | error-budget policy (`docs/observability/error-budget.md`)                     | 🟠 open          | [#942](https://github.com/Skords-01/Sergeant/pull/942) OPEN                                                                                                                                                                                                                                                                                                                                            |
| PR-8.C   | formally closed as duplicate of PR-12.A (doc-only closure)                     | 🟠 open (doc)    | [#939](https://github.com/Skords-01/Sergeant/pull/939) OPEN                                                                                                                                                                                                                                                                                                                                            |
| PR-4.D   | `zod-to-openapi` → generate api-client types from server schemas               | 🟠 branch, no PR | commit `932b6e20` on `devin/1777295404-api-client-codegen` — PR не відкрито                                                                                                                                                                                                                                                                                                                            |
| PR-6.C   | `strict: true` full + remove `allowJs` (final TS phase)                        | ⏳ pending       | після завершення PR-6.B                                                                                                                                                                                                                                                                                                                                                                                |
| Інші     | див. inline-теги нижче                                                         | —                | —                                                                                                                                                                                                                                                                                                                                                                                                      |
...
- `PR-1.A` ✅ closed — [#943](https://github.com/Skords-01/Sergeant/pull/943) `chore(config): enforce inheritance of strict from tsconfig.base in apps/web,server (codeowner-blocking comment)`. Реалізовано як CODEOWNERS-guard + `scripts/check-tsconfig-strict-inheritance.mjs`.
...
- `PR-3.A` 🟠 open (doc-only) — [#941](https://github.com/Skords-01/Sergeant/pull/941) формально subsumed PR-6.A (`strictNullChecks` phase 1, [#870](https://github.com/Skords-01/Sergeant/pull/870)) → PR-6.B (`noImplicitAny` phase 2, [#923](https://github.com/Skords-01/Sergeant/pull/923) / [#934](https://github.com/Skords-01/Sergeant/pull/934)) → PR-6.C (фінальний `strict: true` + remove `allowJs`). Окремий PR-3.A більше не потрібен — цей doc-PR формально це фіксує. Залишилось ⏳: merge PR #941.
...
- `PR-4.D` 🟠 branch, PR не відкрито — commit `932b6e20` (`chore(api-client): generate types from server zod schemas via zod-to-openapi`) існує на `devin/1777295404-api-client-codegen`, але PR на GitHub не створено. Закриває drift у rule #3 автоматично. Залишилось ⏳: відкрити PR з цієї гілки + CI + ревʼю.
...
- `PR-6.C` ⏳ pending — `chore(web,tsconfig): set strict: true (phase 3) + remove allowJs` — фінал. Блокується завершенням PR-6.B (залишилось `core`, `modules/finyk`, `modules/fizruk`).
- `PR-6.D` ✅ closed — [#937](https://github.com/Skords-01/Sergeant/pull/937) `chore(server,tsconfig): explicit strict: true (no implicit inheritance)` — `apps/server/tsconfig.json` тепер явно декларує `strict: true`, уникнувши fragility від silent inheritance.
...
- `PR-7.D` ✅ closed — [#945](https://github.com/Skords-01/Sergeant/pull/945) `ci(ci): weekly flaky-tests dashboard workflow + aggregator script` — GitHub Action, що збирає `vitest --reporter json` за 7 днів і публікує markdown trend в artifact.
- `PR-7.E` 🟡 partial — 1/3 закрито ([#963](https://github.com/Skords-01/Sergeant/pull/963) — de-flake `OnboardingWizard.test.tsx`). Залишилось ⏳: 2/3 + 3/3 mobile flaky тести (кожен у своєму PR; див. `AGENTS.md` — 3 known flaky у `apps/mobile/src/core/**`).
...
- `PR-8.A` 🟠 open — [#942](https://github.com/Skords-01/Sergeant/pull/942) `docs(docs): error-budget policy` — який тип фіч freeze, коли HTTP API budget вигорає; які ні (security fixes, hotfixes). Залишилось ⏳: merge.
- `PR-8.B` ✅ closed (7 PRs) — Prometheus `/metrics` + Grafana dashboards + frontend obs + on-call + logging + metrics-catalog:
  - [#946](https://github.com/Skords-01/Sergeant/pull/946) — Grafana dashboards README + JSONs
  - [#947](https://github.com/Skords-01/Sergeant/pull/947) — on-call routing & escalation guide
  - [#948](https://github.com/Skords-01/Sergeant/pull/948) — Grafana dashboard JSON exports
  - [#949](https://github.com/Skords-01/Sergeant/pull/949) — logging + ALS + Sentry correlation guide
  - [#950](https://github.com/Skords-01/Sergeant/pull/950) — frontend (web+mobile) observability guide
  - [#953](https://github.com/Skords-01/Sergeant/pull/953) — Prometheus metrics reference catalog
  - [#959](https://github.com/Skords-01/Sergeant/pull/959) — dashboard JSON imports fix (`__inputs`, timezone, datasource refs)
- `PR-8.C` 🟠 open (doc-only) — [#939](https://github.com/Skords-01/Sergeant/pull/939) формально закривається як duplicate of PR-12.A ([#864](https://github.com/Skords-01/Sergeant/pull/864)): `SYSTEM_PROMPT_VERSION` + `anthropic_prompt_cache_hit_total{version, outcome}` метрика вже реалізовані там. Залишилось ⏳: merge PR #939.
...
- `PR-10.A` ✅ closed — [#951](https://github.com/Skords-01/Sergeant/pull/951) `ci(ci): p95 pipeline duration trend in PR comments` — скрипт читає GitHub Actions API і публікує trend у PR як коментар.
- `PR-10.B` ✅ closed — [#940](https://github.com/Skords-01/Sergeant/pull/940) `ci(ci): split smoke-e2e into critical-flow + nightly extended-flow`.
- `PR-10.C` ✅ closed — [#944](https://github.com/Skords-01/Sergeant/pull/944) `ci(ci): nightly full audit + osv-scanner dependency check`.
...
- `PR-11.A` ✅ closed — [#952](https://github.com/Skords-01/Sergeant/pull/952) `docs(docs): freshness badges for top-10 docs + nightly overdue-doc issue workflow` — header `**Last validated:** YYYY-MM-DD by @user. **Next review:** YYYY-MM-DD.` + nightly workflow, що відкриває issue для простроченого `Next review`.
- `PR-11.B` ✅ closed — [#955](https://github.com/Skords-01/Sergeant/pull/955) `docs(docs): decision-tree format for top-5 playbooks` (`when ... do X, else Y`).
- `PR-11.C` ✅ substantially closed — ADR практика "живе":
  - **Базові ADRs** до PR-11.C: `docs/adr/0001-monetization-architecture.md` ([#912](https://github.com/Skords-01/Sergeant/pull/912)), `docs/adr/0002-tool-lifecycle.md` ([#926](https://github.com/Skords-01/Sergeant/pull/926)).
  - **Template + README index:** [#938](https://github.com/Skords-01/Sergeant/pull/938) — `docs/adr/TEMPLATE.md` (1-page MADR-adapted skeleton: Status / Context / Considered options / Decision / Consequences / Compliance / Links) + `docs/adr/README.md` (index, naming convention, lifecycle).
  - **Retroactive ADRs 0003-0015** (13 шт.) через [#958](https://github.com/Skords-01/Sergeant/pull/958) + [#962](https://github.com/Skords-01/Sergeant/pull/962) + [#961](https://github.com/Skords-01/Sergeant/pull/961) + [#956](https://github.com/Skords-01/Sergeant/pull/956) — hosting, mobile, storage, RLS, migrations, bigint coercion, observability, turbo, Better Auth, monorepo split, Capacitor wrapper, Anthropic tool-on-client, прочі. Усі 5 originally-planned topics покриті, плюс ще 8.
...
| 5   | `PR-1.A` — enforce strict inheritance (guard)     | 0.5 д  | низький  | уникнути strict drift  | ✅ [#943](https://github.com/Skords-01/Sergeant/pull/943) |
| 6   | `PR-6.D` — apps/server explicit strict: true      | 0.5 д  | низький  | zero implicit inherit  | ✅ [#937](https://github.com/Skords-01/Sergeant/pull/937) |
...
| --- | -------------------------------------------------------- | --------- | -------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 13  | `PR-6.C` — strict: true full + remove allowJs            | 1 тиждень | strict TS done       | ⏳ pending (блокується PR-6.B remainder)                                                                                                                                                                                                                                                                                                                                                              |
| 14  | `PR-4.D` — zod-to-openapi для api-client                 | 1 тиждень | автоматизує rule #3  | 🟠 commit `932b6e20` на `devin/1777295404-api-client-codegen`, PR не відкрито                                                                                                                                                                                                                                                                                                                         |
| 15  | `PR-8.A` + `PR-8.C` — error-budget policy + tool metrics | 3-5 д     | operational maturity | `PR-8.A` 🟠 [#942](https://github.com/Skords-01/Sergeant/pull/942) OPEN; `PR-8.C` 🟠 [#939](https://github.com/Skords-01/Sergeant/pull/939) OPEN (формальна дублікація PR-12.A)                                                                                                                                                                                                                       |
| 16  | `PR-10.B` + `PR-10.C` — split smoke-e2e + nightly audit  | 2-3 д     | CI scaling           | `PR-10.B` ✅ [#940](https://github.com/Skords-01/Sergeant/pull/940); `PR-10.C` ✅ [#944](https://github.com/Skords-01/Sergeant/pull/944)                                                                                                                                                                                                                                                              |
| 17  | `PR-11.A` + `PR-11.C` — freshness badges + ADR template  | 1 тиждень | doc lifecycle        | `PR-11.A` ✅ [#952](https://github.com/Skords-01/Sergeant/pull/952); `PR-11.C` ✅ template [#938](https://github.com/Skords-01/Sergeant/pull/938) + 13 retroactive ADRs ([#956](https://github.com/Skords-01/Sergeant/pull/956)/[#958](https://github.com/Skords-01/Sergeant/pull/958)/[#961](https://github.com/Skords-01/Sergeant/pull/961)/[#962](https://github.com/Skords-01/Sergeant/pull/962)) |
| 18  | `PR-3.B/C` next 5 — file decomposition next wave         | 1-2 тижні | regression-surface   | ⏳ pending (top-3 зроблено у PR-3.B/C/D; залишилось ⏳ наступні файли з >600 LOC списку)                                                                                                                                                                                                                                                                                                              |

### Що залишилось зробити (станом на 2026-04-27, сьома ревізія)

**🟠 Відкриті PR, чекають merge (3 шт., усі doc-only або невеликі):**

| PR                | Гілка / PR                                             | Що робить                                                                                                       |
| ----------------- | ------------------------------------------------------ | --------------------------------------------------------------------------------------------------------------- |
| `PR-3.A` (formal) | [#941](https://github.com/Skords-01/Sergeant/pull/941) | Doc-only: формально subsume `PR-3.A` у `PR-6.A/6.B/6.C` (strict TS phased rollout).                             |
| `PR-8.A`          | [#942](https://github.com/Skords-01/Sergeant/pull/942) | `docs(docs): error-budget policy` — коли freeze-фічі, коли hotfix-only, за SLO.                                 |
| `PR-8.C` (formal) | [#939](https://github.com/Skords-01/Sergeant/pull/939) | Doc-only: формально закрити як duplicate of `PR-12.A` ([#864](https://github.com/Skords-01/Sergeant/pull/864)). |

**🟠 Гілка є, PR не відкрито (1 шт.):**

| PR       | Гілка                                                     | Що робить                                                                                                                                |
| -------- | --------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------- |
| `PR-4.D` | `devin/1777295404-api-client-codegen` (commit `932b6e20`) | `chore(api-client): generate types from server zod schemas via zod-to-openapi` — автоматизує rule #3. Потрібно відкрити PR, прогнати CI. |

**⏳ Не розпочато або частково — потрібні нові PR (6 шт.):**

| PR              | Опис                                                                                                          | Effort | Blocker / залежність         |
| --------------- | ------------------------------------------------------------------------------------------------------------- | ------ | ---------------------------- |
| `PR-6.B.core`   | `feat(web): enable noImplicitAny on apps/web/src/core/**` (наступна фаза PR-6.B після routine/nutrition).     | 1-2 д  | —                            |
| `PR-6.B.finyk`  | `feat(web): enable noImplicitAny on apps/web/src/modules/finyk/**`.                                           | 1-2 д  | —                            |
| `PR-6.B.fizruk` | `feat(web): enable noImplicitAny on apps/web/src/modules/fizruk/**`.                                          | 1-2 д  | —                            |
| `PR-6.C`        | `chore(web,tsconfig): set strict: true (phase 3) + remove allowJs` — фінал strict-rollout.                    | 1 тиж  | Блокується PR-6.B (3 шт. ↑). |
| `PR-7.E` 2/3    | `test(mobile): de-flake 2/3 known flaky test` (див. `AGENTS.md` → 3 known flaky у `apps/mobile/src/core/**`). | 0.5 д  | —                            |
| `PR-7.E` 3/3    | `test(mobile): de-flake 3/3 known flaky test`.                                                                | 0.5 д  | —                            |
