...
> **Статус виконання — оновлено 2026-04-27 (сьома ревізія: +PR-1.A, +PR-6.D, +PR-7.D, +PR-8.B, +PR-10.A, +PR-10.B link, +PR-11.A, +PR-11.B, +PR-11.C substantially complete, +PR-8.A closed (#942); +PR-4.D branch, +PR-3.A/8.C formal closure open)**
...
| PR-8.A   | error-budget policy (`docs/observability/error-budget.md`)                     | ✅ closed        | [#942](https://github.com/Skords-01/Sergeant/pull/942)                                                                                                                                                                                                                                                                                                                                                 |
...
- `PR-8.A` ✅ closed — [#942](https://github.com/Skords-01/Sergeant/pull/942) `docs(docs): error-budget policy` — який тип фіч freeze, коли HTTP API budget вигорає; які ні (security fixes, hotfixes).
...
| 15  | `PR-8.A` + `PR-8.C` — error-budget policy + tool metrics | 3-5 д     | operational maturity | `PR-8.A` ✅ [#942](https://github.com/Skords-01/Sergeant/pull/942); `PR-8.C` 🟠 [#939](https://github.com/Skords-01/Sergeant/pull/939) OPEN (формальна дублікація PR-12.A)                                                                                                                                                                                                                            |
...
**🟠 Відкриті PR, чекають merge (2 шт., обидва doc-only закриваючі розбіжності):**
