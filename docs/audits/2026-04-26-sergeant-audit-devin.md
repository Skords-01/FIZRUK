...
- `PR-10.B` — `ci: split smoke-e2e into critical-flow (must-pass) + extended-flow (nightly)`. ✅ closed — [#940](https://github.com/Skords-01/Sergeant/pull/940)
...
| 16  | `PR-10.B` + `PR-10.C` — split smoke-e2e + nightly audit  | 2-3 д     | CI scaling           | `PR-10.B` ✅ closed — [#940](https://github.com/Skords-01/Sergeant/pull/940) |
