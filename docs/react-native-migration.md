...
| 2   | Hub-ядро                                                    | 🔵 In progress | 1                            | BRANDBOOK native-patterns (Q9) ✅ #409. `ErrorBoundary` + `ModuleErrorBoundary` ✅ PR [#434](https://github.com/Skords-01/Sergeant/pull/434). `SyncStatusIndicator` ✅ PR [#441](https://github.com/Skords-01/Sergeant/pull/441). HubSettings: shell + `RoutineSection` + `ExperimentalSection` ✅ PR [#443](https://github.com/Skords-01/Sergeant/pull/443); `GeneralSection` ✅ PR [#444](https://github.com/Skords-01/Sergeant/pull/444); `NotificationsSection` ✅ PR [#445](https://github.com/Skords-01/Sergeant/pull/445); `FinykSection` + `FizrukSection` + `AIDigestSection` ✅ PR [#456](https://github.com/Skords-01/Sergeant/pull/456) — усі 6 секцій HubSettings портовані. Далі: `Dashboard` (стартовий hub-екран замість скафолду), `OnboardingWizard`, HubChat / HubSearch / HubReports.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
