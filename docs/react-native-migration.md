...
| 1   | Спільна UI-основа для RN (+ NativeWind + MMKV + Dev Client) | 🔵 In progress | 0                            | NativeWind (Q5) ✅ #403, MMKV-сховище (Q3) ✅ #404, `@sergeant/design-tokens` (R6) ✅ #406, Expo Dev Client через EAS (Q4) ✅ #408/#410, `Button` ✅ #407, `Card` ✅ #413 (+ jest-expo setup), `Input` ✅ #417, `Banner` ✅ #419, `Toast` ✅ #421, `Skeleton` ✅ #423, `Sheet` ✅ #426. В роботі: `ConfirmDialog` — PR [#427](https://github.com/Skords-01/Sergeant/pull/427) по шаблону #407.                                                                       |
