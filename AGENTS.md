...
### 11. Read governance before coding; update docs alongside code
...
1. **`AGENTS.md`** — Hard Rules (#1–#11), Module ownership map for the path you're touching, AI-marker conventions, Domain invariants.
